...
import { BLOG_DESCRIPTION, BLOG_HEADING } from "@/lib/blog-metadata";
...
export type ArchiveKind = "Blog" | "Category";
...
const NARROWED: Record<ArchiveKind, "category" | null> = {
  Blog: null,
  Category: "category",
};

export function BlogFront({
  archive,
  cover,
}: {
  archive: PostArchive;
