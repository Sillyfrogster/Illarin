...
type Rail = "details" | "history" | "publish" | null;
  ...
  return (
    <div className={`${shellClasses} pt-6 pb-40`}>
      <div className="mx-auto max-w-[64rem]">
        ...
        <PostNotices onOpenPublish={() => setRail("publish")} post={post} />
        ...
        {showingReader ? (
          <article className="mt-group">
            ...
            <div className="mt-group max-w-[70ch]">
              <ArticleBody body={draft.body} media={media} />
            </div>
          </article>
        ) : null}
          ...
          >
            ...
            <div className="max-w-[70ch]">
              <WritingSurface
                ...
                onUpload={(file) => upload("body", file)}
              />
            </div>
          </div>
        )}
      ...
      <Dock
        actions={
          <>
            ...
            <DockAction
              onClick={() =>
                setRail((open) => (open === "publish" ? null : "publish"))
              }
              strong
            >
              {publishLabel(post)}
...
function detail(state: Saving, post: Post, refusal: string): string {
  ...
  if (standing === "unpublished")
    return "The post is unpublished from public view.";
