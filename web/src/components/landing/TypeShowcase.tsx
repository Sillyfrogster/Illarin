...
export function TypeShowcase() {
  return (
    <section
      id="explore"
      aria-labelledby="landing-types-title"
      ...
      <Shell>
        <Reveal className="mb-12 grid items-end gap-6 sm:mb-16 lg:grid-cols-[1.2fr_.8fr] lg:gap-24">
          ...
          <p className="max-w-[370px] text-lede text-mute">
            Find characters, presets and more for your roleplay app, with
            previews and compatible downloads.
          </p>
        </Reveal>
        <div className="grid items-start gap-10 md:grid-cols-[1.12fr_1fr] md:gap-8 lg:gap-12">
          <Reveal>
            <Link
              href="/browse?type=character"
