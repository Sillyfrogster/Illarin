...
// renamedPaths is every path the API answered to before the rename, with the path it answers to now
var renamedPaths = []struct{ method, was, now string }{
	...
	{"GET", "/v1/assets/:id/revisions", "/v1/works/:id/revisions"},
	{"POST", "/v1/assets/:id/revisions", "/v1/works/:id/revisions"},
	{"POST", "/v1/assets/:id/revisions/:operationId/accept", "/v1/works/:id/revisions/:operationId/accept"},
	{"DELETE", "/v1/assets/:id/revisions/:operationId", "/v1/works/:id/revisions/:operationId"},
	...
	{"GET", "/v1/assets/:id/updates", "/v1/works/:id/updates"},
	{"POST", "/v1/assets/:id/updates", "/v1/works/:id/updates"},
	{"GET", "/v1/assets/:id/updates/comparison", "/v1/works/:id/updates/comparison"},
	{"GET", "/v1/assets/:id/updates/protection", "/v1/works/:id/updates/protection"},
	{"PUT", "/v1/assets/:id/updates/:number/protection", "/v1/works/:id/updates/:number/protection"},
	{"POST", "/v1/assets/:id/updates/:number/restore", "/v1/works/:id/updates/:number/restore"},
	{"POST", "/v1/assets/:id/updates/:number/withdraw", "/v1/works/:id/updates/:number/withdraw"},
	{"PATCH", "/v1/assets/:id/updates/:number/notes", "/v1/works/:id/updates/:number/notes"},
	{"GET", "/v1/assets/:id/updates/:number/downloads", "/v1/works/:id/updates/:number/downloads"},
