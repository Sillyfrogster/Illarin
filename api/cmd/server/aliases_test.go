...
var renamedPaths = []struct{ method, was, now string }{
	...
	{"GET", "/v1/assets/:id/vault", "/v1/works/:id/found-images"},
	{"DELETE", "/v1/assets/:id/vault/:pictureId", "/v1/works/:id/found-images/:pictureId"},
	{"POST", "/v1/assets/:id/vault/:pictureId/place", "/v1/works/:id/found-images/:pictureId/place"},
	{"GET", "/v1/works/:id/vault", "/v1/works/:id/found-images"},
	{"DELETE", "/v1/works/:id/vault/:pictureId", "/v1/works/:id/found-images/:pictureId"},
	{"POST", "/v1/works/:id/vault/:pictureId/place", "/v1/works/:id/found-images/:pictureId/place"},
