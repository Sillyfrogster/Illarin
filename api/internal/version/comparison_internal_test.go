...
func recordedVersionOf(kind string, blocks ...block.Block) work.Snapshot {
	return work.Snapshot{Kind: kind, Metadata: work.VersionMetadata{Name: "Recorded"}, Blocks: blocks}
}
