...
func ToPage(found Detail, visibility asset.ContentVisibility) (AssetDetail, error) {
...
func ToImages(images []asset.DetailImage) []AssetImage {
...
func ToRecordedVersion(recorded asset.Version) RecordedVersion {
