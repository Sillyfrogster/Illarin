...
func Register(r *gin.Engine, h *Handlers, d Deadlines, readiness Readiness) error {
	...
	limits := map[string]time.Duration{
		...
		routeKey(http.MethodGet, "/v1/notifications"):                                        d.JSON,
		...
		routeKey(http.MethodGet, "/v1/assets/:id/vault"):                                     d.JSON,
		routeKey(http.MethodPost, "/v1/assets/:id/vault/:pictureId/place"):                   d.JSON,
		routeKey(http.MethodDelete, "/v1/assets/:id/vault/:pictureId"):                       d.JSON,
		...
		routeKey(http.MethodPost, "/v1/assets/:id/updates/:number/restore"):                  d.JSON,
		routeKey(http.MethodPatch, "/v1/assets/:id/updates/:number/notes"):                   d.JSON,
		routeKey(http.MethodPost, "/v1/assets/:id/updates/:number/withdraw"):                 d.JSON,
		routeKey(http.MethodGet, "/v1/assets/:id/updates/protection"):                        d.JSON,
		routeKey(http.MethodGet, "/v1/assets/:id/updates/:number/downloads"):                 d.JSON,
