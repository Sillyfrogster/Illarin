# Illarin app integration guide

This guide is for developers adding Illarin support to an app. If the API
behaves differently from this guide, report the mismatch. All API paths below are relative to the exact Illarin base URL and include the
public `/api` prefix.
