...
# Walks an operator through the parts of production setup that need a browser.
...
banner() {
  ...
  printf '%s  You drive the browser; this setup tells you exactly what to do and\n' "$DIM"
...
write_env STORAGE_FREE_SPACE_RESERVE_BYTES "5368709120"
write_env ACCOUNT_STORAGE_CAP_BYTES "1073741824"
chmod 0600 "$ENV_FILE"
